...
export class GameOverScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(width / 2, panelY + 48, '♟  PUZZLE COMPLETE', {
      fontSize: '34px', fontFamily: 'Poppins, sans-serif', color: textGold, fontStyle: 'bold',
    }).setOrigin(0.5);
    ...
    const prompt = this.add.text(width / 2, height - 48, '● TAP OR PRESS ENTER FOR NEW GAME ●', {
      fontSize: '18px', fontFamily: 'Poppins, sans-serif', color: promptColor, fontStyle: 'bold',
    }).setOrigin(0.5);
